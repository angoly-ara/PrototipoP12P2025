...
void Facultad::mostrarDatos() {
    ...
    cout << "Promedio general de la facultad: " << promedioFacultad << endl;
    cout << "Nota más alta: " << getMayorNota() << endl;
    cout << "Nota más baja: " << getMenorNota() << endl;
    cout << "----------------------------------------" << endl;
}
